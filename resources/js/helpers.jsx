...
export const isToday = (date) => {
    ...
    return (
        date.getDate() === today.getDate() && date.getMonth() === today.getMonth() && date.getYear() === today.getYear()
    )
}
...
export const isYesterday = (date) => {
    ...
    return (
        date.getDate() === yesterday.getDate() && date.getMonth() === yesterday.getMonth() && date.getYear() === yesterday.getYear()
    );
}
...
export const formatBytes = (bytes, decimal = 2) => {
    ...
    const k = 1024, dm = decimal < 0 ? 0 : decimal, sizes = ["Bytes", "KB", "MB", "GB"];
