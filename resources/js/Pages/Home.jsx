...
const Home = ({ selectedConversation = null, messages = null }) => {
    ...
    const messageCreated = (message) => {
        ...
        if(
            selectedConversation && selectedConversation.is_user && 
    ...
    useEffect(() => {
        // Recover scroll position after loading old messages
    ...
    return (
        <>
            {!messages && (
                <div className='flex flex-col gap-8 justify-center text-center items-center h-full opacity-35'>
