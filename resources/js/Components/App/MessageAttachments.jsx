...
import { ArrowDownTrayIcon, PlayCircleIcon, PaperClipIcon } from "@heroicons/react/24/solid"
            ...
            {attachments.length > 0 && (
                <div className="mt-2 flex flex-wrap justify-end gap-1">
                    {attachments.map((attachment, ind) => (
                        <div
                            onClick={(e) => attachmentClick(attachments, ind)}
                            key={attachment.id}
                        ...
                        >
                            {!isAudio(attachment) && (
                                <a 
                                    ...
                                    flex items-center justify-center text-gray-100 bg-gray-700 
                                    rounded absolute top-0 right-0 top-cursor-pointer hover:bg-gray-800"
                                >
