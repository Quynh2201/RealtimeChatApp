...
export default function MessageInput({ conversation = null }) {
    ...
    const onSendClick = () => {
        ...
        if(newMessage.trim() === "" && chosenFiles.length === 0) {
            setInputErrorMessage("Please provide a message or an attachment.");
        ...
        axios.post(route("message.store"), formData, {
            ...
            setInputErrorMessage(err || "An error occurred while sending message.")
        })
    }
        ...
        <div className="flex  flex-wrap items-start border-t border-slate-700 py-3">
            ...
            <div className="order-1 px-3 xs:p-0 min-w-[220px] basis-full xs:basis-0 xs:order-2 flex-1 relative">
                <div className="flex ">
                    <NewMessageInput
                        ...
                        onSend={onSendClick}
                    />
                    <button onClick={onSendClick} className="btn btn-info rounded-l-none" disabled={isSending}>
                        {isSending && (
            ...
            <div className="order-3 xs:order-3 p-2 flex">
                ...
                <button className="p-1 text-gray-400 hover:text-gray-300">
                    <HandThumbUpIcon className="w-6 h-6" onClick={onLikeClick} />
                </button>
            </div>
        </div>
    )
