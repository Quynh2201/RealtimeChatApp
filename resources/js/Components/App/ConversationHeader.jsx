    ...
    return (
        <>
            {selectedConversation && (
                <div className="flex p-3 justify-between items-center border-b border-slate-700">
                    {/* Avatar, Chat's name + Number of people in the chat */}
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="ml-2">{selectedConversation.name}</h3>
